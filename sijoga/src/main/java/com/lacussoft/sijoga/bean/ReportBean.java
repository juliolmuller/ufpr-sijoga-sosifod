	...
	public void printReport(int id, String report)
        {
            String path = null;
            Connection con = null;
            if(report.equals("Parte")){path = "/reports/Parte.jrxml";}
            else if(report.equals("FechadosAd")){path = "/reports/FechadosAd.jrxml";}
            else if(report.equals("AbertosAd")){path = "/reports/AbertosAd.jrxml";}
            ...
            try {
                ...
                con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/dac_sijoga", "postgres", "datascienz");
